...
public class principal {
 ...
 Scanner sc = new Scanner(System.in);
        ...
        //Usamos los metodos MuestraMensajePeso y MuestraMayorDeEdad para realizar la misma accion para cada objeto
    ...
    public static void MuestraMensajePeso(Persona p) {
        ...
        switch (IMC) {
            case Persona.pesoIdeal:
                ...
                break;
            case Persona.debajoDelPesoIdeal:
